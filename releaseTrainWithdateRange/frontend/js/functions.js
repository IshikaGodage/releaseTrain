...
function getData(product){
  ...
  if (product!="all"){
    ...
    $.ajax({
      url:"https://"+url+":"+port+"/releaseTrainServices/getProductWiseReleases/"+product+"/"+startTs+"/"+endTs,
      async:false,
      success: function(data){
        console.log(data);
        sendData=data;
    ...
    $.ajax({
      url:"https://"+url+":"+port+"/releaseTrainServices/getAllReleases/"+startTs+"/"+endTs,
      async:false,
      success: function(data){
        console.log(data);
        sendData=data;
